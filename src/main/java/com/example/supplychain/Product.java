...
public class Product {
    ...
    // This Method is to get all products by their name
    public static ObservableList<Product> getProductsByName(String name){
        DatabaseConnection dbConn = new DatabaseConnection();
        ObservableList<Product> data = FXCollections.observableArrayList();  // %s will be replaced by name others will balance each other
